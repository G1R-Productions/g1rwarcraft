...
public class Ore1 extends BlockContainer {

	public Ore1(Material material) {
		super(material);
	...
	public Item getItemDropped(int i, Random random, int j) {
		return this == grwarcraft.Ore1 ? grwarcraft.itemrawore3 : Item.getItemFromBlock(this);
		
	}
	public int quantityDropped(Random random) {
		return this == grwarcraft.Ore1 ? 1 + random.nextInt(2) : 1;
