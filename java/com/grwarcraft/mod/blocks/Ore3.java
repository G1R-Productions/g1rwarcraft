...
public class Ore3 extends BlockContainer {

	public Ore3(Material material) {
		super(material);
	...
	public Item getItemDropped(int i, Random random, int j) {
		return this == grwarcraft.Ore3 ? grwarcraft.itemrawore3 : Item.getItemFromBlock(this);
		
	}
	public int quantityDropped(Random random) {
		return this == grwarcraft.Ore3 ? 1 + random.nextInt(2) : 1;
